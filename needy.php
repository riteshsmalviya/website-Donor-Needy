    ...
    <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Needy</h1>
                <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Please fill the entries properly so that you get
                    relevant details about the donors</p>
            </div>
            <form action="needy.php" method="post">
...
$sql = "SELECT * FROM `covid` WHERE `resource`='$resource' AND `locality`='$locality';";
...
if($num> 0){
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo "<tr><td>". $row["name"]. "</td><td>". $row["email"]. "</td><td>". $row["phone"]. "</td><td>". $row["resource"]. "</td><td>". $row["locality"]. "</td></tr>";
        echo "<br>";
    }
